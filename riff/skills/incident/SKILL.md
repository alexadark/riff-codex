...
Recommend the smallest safe containment action and ask before destructive or external changes not already authorized. Load `.riff/references/security.md` for a security boundary. Record decisions and events concisely under `.riff-state/`; do not resume normal waves until the incident boundary is stable.
